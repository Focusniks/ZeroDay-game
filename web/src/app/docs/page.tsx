...
export default function DocsPage() {
  ...
  const sections = useMemo<DocSection[]>(
    () => [
      ...
      {
        id: "runtime",
        title: "3) Запуск в игре",
        summary:
          "Скрипты запускаются из игрового терминала и подхватываются из папки Scripts/.",
        bullets: [
          "Команда терминала: hackrun <file>.",
          "Скрипты берутся из папки Scripts/.",
          "Расширение .hack можно не указывать, оно подставится автоматически.",
          "Tab-complete помогает для команд и .hack файлов.",
        ],
      },
      {
        id: "limits",
        title: "4) Ограничения выполнения",
        summary:
          "Для стабильности симуляции в рантайме есть лимиты по итерациям, выводу и общему числу инструкций.",
        bullets: [
          "Лимит итераций range: до 10 000.",
